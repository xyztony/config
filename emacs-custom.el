(custom-set-variables
 ...
 '(package-selected-packages
   '(popper origami denote vundo howm symbol-overlay lsp-java dap-mode vterm marginalia meow projectile-ripgrep edit-indirect projectile flutter dart-mode exec-path-from-shell markdown-mode evil-org prescient magit vertico-prescient kaolin-themes))
